...
def get_pet_labels(image_dir):
    ...
    thinking there won't be any two files with the same name inside the 
    same directory. 
    """
    for filename in filename_list: 
        filename_filtered = filename.lower().strip() 
        filename_split = filename_filtered.split('_') 
        pet_name = ""
        ...
        pet_label_list.append([pet_name.strip()]) 
        
    result_dic = dict(zip(filename_list, pet_label_list)) 
