    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic: 
            ...
            if sum(results_dic[key][3:]) == 1: 
                message = "Pet {:>26} is a {:>10} - Classified as {:>10}" 
                pet_label = results_dic[key][0]
                pet_label_is_dog = "" 
                classifier_label_is_dog = "" 

                if results_dic[key][3] == 1: 
                    pet_label_is_dog += "DOG" 
                else: 
                    pet_label_is_dog += "NOT-A-DOG" 
                if results_dic[key][4] == 1: 
                    classifier_label_is_dog += "DOG" 
                else: 
                    classifier_label_is_dog += "NOT-A-DOG" 
                    
                print(message.format(pet_label, pet_label_is_dog, classifier_label_is_dog)) 
